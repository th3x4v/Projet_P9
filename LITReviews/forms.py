...
class ReviewTicketForm(forms.ModelForm):
    ...
    description = forms.CharField(max_length=2048, widget=forms.Textarea(attrs={'rows': 2}),required=False)
    ...
    body = forms.CharField(max_length=8192, widget=forms.Textarea(attrs={'rows': 4}),required=False)
